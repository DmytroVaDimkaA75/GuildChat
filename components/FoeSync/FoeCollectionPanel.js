...
const styles = StyleSheet.create({
  ...
  savedHint: { color: C.textSecondary, fontSize: 12, lineHeight: 18, paddingVertical: 8 },
  ...
  filterBtnActive: { borderColor: C.primary, backgroundColor: `${C.primary}2b` },
  ...
  eraBtnActive: { borderColor: C.primary, backgroundColor: `${C.primary}2b` },
  ...
  saveTitle: { color: C.text, fontSize: 18, fontWeight: '700', marginBottom: 14 },
  saveInput: {
    minHeight: 48,
    color: C.text,
    fontSize: 15,
  ...
  saveOkTxt: { color: '#fff', fontSize: 14, fontWeight: '700' },
});
