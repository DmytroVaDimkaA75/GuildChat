...
const fetchLinkPreview = async (rawUrl) => {
  ...
  for (let redirectCount = 0; redirectCount <= MAX_REDIRECTS; redirectCount += 1) {
    ...
    const response = await fetch(url, {
      ...
      headers: { "user-agent": "GuildChat-LinkPreview/1.0", accept: "text/html,application/xhtml+xml" },
    });
...
module.exports = { extractLinkMetadata, fetchLinkPreview, isPrivateAddress, normalizePreviewUrl };
