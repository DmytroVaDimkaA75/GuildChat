...
const ukTranslation = {
  ...
  userSettings: {
    ...
    loginErrorMessage: "Перевірте з’єднання та спробуйте ще раз."
  },
  googleAuth: {
    signIn: "Увійти через Google",
    notLinkedTitle: "Вхід через Google не підключено",
    notLinkedMessage: "Увійдіть за кодом доступу та підключіть вхід через Google у Профілі.",
    configurationMissingTitle: "Вхід через Google не налаштовано",
    configurationMissingMessage: "Для цієї збірки ще не налаштовано вхід через Google.",
    errorTitle: "Помилка входу через Google",
    errorMessage: "Не вдалося увійти через Google. Спробуйте ще раз.",
    title: "Вхід через Google",
    description: "Підключіть вхід через Google, щоб надалі входити без коду доступу.",
    loading: "Перевіряємо підключення…",
    sessionRequired: "Сесію входу не підтверджено. Увійдіть у GuildChat знову, щоб керувати входом через Google.",
    unlinked: "Вхід через Google не підключено",
    linked: "Вхід через Google підключено",
    emailFallback: "Підключений обліковий запис Google",
    link: "Підключити Google",
    unlink: "Відключити вхід через Google",
    retry: "Повторити",
    unlinkTitle: "Відключити вхід через Google?",
    unlinkMessage: "Після відключення вхід через Google стане недоступним. Якщо ви не пам’ятаєте код доступу, підключіть інший Google-акаунт до виходу із GuildChat.",
    cancel: "Скасувати",
    unlinkConfirm: "Відключити",
    loadFailed: "Не вдалося перевірити стан входу через Google.",
    linkFailed: "Не вдалося підключити вхід через Google.",
    unlinkFailed: "Не вдалося відключити вхід через Google.",
    statusRefreshFailed: "Налаштування входу змінено, але не вдалося оновити його стан. Перевірте ще раз."
  },
  chatStack: {
  ...
  gbgScreen: {
    ...
    sectorNotifications: {
      muteTitle: "Вимкнути звук сповіщень",
      unmuteTitle: "Увімкнути звук сповіщень",
  ...
  drawer: {
    ...
    logoutLabel: "Вихід",
    logoutTitle: "Вийти із застосунку?",
    logoutMessage: "Буде очищено кеш і всі локальні дані застосунку. Дані вашого акаунта на сервері не видаляться.",
    logoutCancel: "Скасувати",
    logoutConfirm: "Вийти",
    logoutErrorTitle: "Не вдалося вийти",
    logoutErrorMessage: "Не вдалося очистити локальні дані. Спробуйте ще раз."
  },
  gbScreen: {
...
const ruTranslation = {
  ...
  userSettings: {
    ...
    loginErrorMessage: "Проверьте соединение и попробуйте ещё раз."
  },
  googleAuth: {
    signIn: "Войти через Google",
    notLinkedTitle: "Google-аккаунт не привязан",
    notLinkedMessage: "Войдите по коду доступа и привяжите Google в Профиле.",
    configurationMissingTitle: "Вход через Google не настроен",
    configurationMissingMessage: "Для этой сборки Google Sign-In ещё не настроен.",
    errorTitle: "Ошибка Google",
    errorMessage: "Не удалось войти через Google. Попробуйте ещё раз.",
    title: "Google-аккаунт",
    description: "Привяжите Google, чтобы в дальнейшем входить без кода доступа.",
    loading: "Проверяем привязку…",
    sessionRequired: "Сессия входа не подтверждена. Войдите в GuildChat снова, чтобы управлять входом через Google.",
    unlinked: "Google не привязан",
    linked: "Google привязан",
    emailFallback: "Привязанный Google-аккаунт",
    link: "Привязать Google",
    unlink: "Отвязать",
    retry: "Повторить",
    unlinkTitle: "Отвязать Google?",
    unlinkMessage: "После отвязки вход через Google станет недоступен. Если вы не помните код доступа, привяжите другой Google-аккаунт до выхода из GuildChat.",
    cancel: "Отмена",
    unlinkConfirm: "Отвязать",
    loadFailed: "Не удалось проверить привязку Google.",
    linkFailed: "Не удалось привязать Google-аккаунт.",
    unlinkFailed: "Не удалось отвязать Google-аккаунт.",
    statusRefreshFailed: "Привязка изменена, но обновить её состояние не удалось. Проверьте ещё раз."
  },
  chatStack: {
  ...
  gbgScreen: {
    ...
    sectorNotifications: {
      muteTitle: "Выключить звук уведомлений",
      unmuteTitle: "Включить звук уведомлений",
  ...
  drawer: {
    ...
    logoutMessage: "Кэш и все локальные данные приложения будут очищены. Данные аккаунта на сервере не удалятся.",
    logoutCancel: "Отмена",
    logoutConfirm: "Выйти",
    logoutErrorTitle: "Не удалось выйти",
    logoutErrorMessage: "Не удалось очистить локальные данные. Попробуйте ещё раз."
  },
  gbScreen: {
...
const beTranslation = {
  ...
  userSettings: {
    ...
    close: "Закрыць",
    ok: "OK",
    loginErrorTitle: "Не ўдалося ўвайсці",
    loginErrorMessage: "Праверце злучэнне і паспрабуйце яшчэ раз."
  },
  googleAuth: {
    signIn: "Увайсці праз Google",
    notLinkedTitle: "Google-акаўнт не прывязаны",
    notLinkedMessage: "Увайдзіце па кодзе доступу і прывяжыце Google у Профілі.",
    configurationMissingTitle: "Уваход праз Google не наладжаны",
    configurationMissingMessage: "Для гэтай зборкі Google Sign-In яшчэ не наладжаны.",
    errorTitle: "Памылка Google",
    errorMessage: "Не ўдалося ўвайсці праз Google. Паспрабуйце яшчэ раз.",
    title: "Google-акаўнт",
    description: "Прывяжыце Google, каб надалей уваходзіць без кода доступу.",
    loading: "Правяраем прывязку…",
    sessionRequired: "Сесія ўваходу не пацверджана. Увайдзіце ў GuildChat зноў, каб кіраваць уваходам праз Google.",
    unlinked: "Google не прывязаны",
    linked: "Google прывязаны",
    emailFallback: "Прывязаны Google-акаўнт",
    link: "Прывязаць Google",
    unlink: "Адвязаць",
    retry: "Паўтарыць",
    unlinkTitle: "Адвязаць Google?",
    unlinkMessage: "Пасля адвязвання ўваход праз Google стане недаступным. Калі вы не памятаеце код доступу, прывяжыце іншы Google-акаўнт да выхаду з GuildChat.",
    cancel: "Скасаваць",
    unlinkConfirm: "Адвязаць",
    loadFailed: "Не ўдалося праверыць прывязку Google.",
    linkFailed: "Не ўдалося прывязаць Google-акаўнт.",
    unlinkFailed: "Не ўдалося адвязаць Google-акаўнт.",
    statusRefreshFailed: "Прывязка зменена, але абнавіць яе стан не ўдалося. Праверце яшчэ раз."
  },
  chatStack: {
    chatScreenTitle: "Альтанка",
  ...
  gbgScreen: {
    ...
    sectorNotifications: {
      muteTitle: "Выключыць гук апавяшчэнняў",
      unmuteTitle: "Уключыць гук апавяшчэнняў",
  ...
  drawer: {
    ...
    logoutLabel: "Выхад",
    logoutTitle: "Выйсці з праграмы?",
    logoutMessage: "Кэш і ўсе лакальныя даныя праграмы будуць ачышчаны. Даныя акаўнта на серверы не выдаляцца.",
    logoutCancel: "Скасаваць",
    logoutConfirm: "Выйсці",
    logoutErrorTitle: "Не ўдалося выйсці",
    logoutErrorMessage: "Не ўдалося ачысціць лакальныя даныя. Паспрабуйце яшчэ раз."
  },
  gbScreen: {
...
const deTranslation = {
  ...
  userSettings: {
    ...
    loginErrorMessage: "Prüfen Sie die Verbindung und versuchen Sie es erneut."
  },
  googleAuth: {
    signIn: "Mit Google anmelden",
    notLinkedTitle: "Google-Konto nicht verknüpft",
    notLinkedMessage: "Melden Sie sich mit dem Zugangscode an und verknüpfen Sie Google im Profil.",
    configurationMissingTitle: "Google-Anmeldung nicht konfiguriert",
    configurationMissingMessage: "Google Sign-In ist für diesen Build noch nicht konfiguriert.",
    errorTitle: "Google-Fehler",
    errorMessage: "Die Anmeldung mit Google ist fehlgeschlagen. Bitte versuchen Sie es erneut.",
    title: "Google-Konto",
    description: "Verknüpfen Sie Google, um sich künftig ohne Zugangscode anzumelden.",
    loading: "Verknüpfung wird geprüft…",
    sessionRequired: "Die Anmeldesitzung ist nicht bestätigt. Melden Sie sich erneut bei GuildChat an, um die Google-Anmeldung zu verwalten.",
    unlinked: "Google ist nicht verknüpft",
    linked: "Google ist verknüpft",
    emailFallback: "Verknüpftes Google-Konto",
    link: "Google verknüpfen",
    unlink: "Verknüpfung aufheben",
    retry: "Erneut versuchen",
    unlinkTitle: "Google-Verknüpfung aufheben?",
    unlinkMessage: "Nach dem Aufheben ist die Google-Anmeldung nicht mehr verfügbar. Falls Sie Ihren Zugangscode nicht kennen, verknüpfen Sie vor dem Abmelden ein anderes Google-Konto.",
    cancel: "Abbrechen",
    unlinkConfirm: "Verknüpfung aufheben",
    loadFailed: "Die Google-Verknüpfung konnte nicht geprüft werden.",
    linkFailed: "Das Google-Konto konnte nicht verknüpft werden.",
    unlinkFailed: "Die Google-Verknüpfung konnte nicht aufgehoben werden.",
    statusRefreshFailed: "Die Verknüpfung wurde geändert, ihr Status konnte aber nicht aktualisiert werden. Prüfen Sie ihn erneut."
  },
  chatStack: {
  ...
  gbgScreen: {
    ...
    sectorNotifications: {
      muteTitle: "Benachrichtigungston ausschalten",
      unmuteTitle: "Benachrichtigungston einschalten",
  ...
  drawer: {
    ...
    logoutTitle: "Von der App abmelden?",
    logoutMessage: "Der Cache und alle lokalen App-Daten werden gelöscht. Ihre Kontodaten auf dem Server bleiben erhalten.",
    logoutCancel: "Abbrechen",
    logoutConfirm: "Abmelden",
    logoutErrorTitle: "Abmeldung fehlgeschlagen",
    logoutErrorMessage: "Die lokalen Daten konnten nicht gelöscht werden. Versuchen Sie es erneut."
  },
  gbScreen: {
...
const enOverrides = {
  ...
  userSettings: {
    ...
    loginErrorMessage: "Check your connection and try again."
  },
  googleAuth: {
    signIn: "Sign in with Google",
    notLinkedTitle: "Google account not linked",
    notLinkedMessage: "Sign in with your access code and link Google in Profile.",
    configurationMissingTitle: "Google sign-in is not configured",
    configurationMissingMessage: "Google Sign-In has not been configured for this build yet.",
    errorTitle: "Google error",
    errorMessage: "Could not sign in with Google. Try again.",
    title: "Google account",
    description: "Link Google to sign in without an access code next time.",
    loading: "Checking the link…",
    sessionRequired: "Your sign-in session is not verified. Sign in to GuildChat again to manage Google sign-in.",
    unlinked: "Google is not linked",
    linked: "Google is linked",
    emailFallback: "Linked Google account",
    link: "Link Google",
    unlink: "Unlink",
    retry: "Retry",
    unlinkTitle: "Unlink Google?",
    unlinkMessage: "Google sign-in will stop working after unlinking. If you do not know your access code, link another Google account before signing out of GuildChat.",
    cancel: "Cancel",
    unlinkConfirm: "Unlink",
    loadFailed: "Could not check the Google link.",
    linkFailed: "Could not link the Google account.",
    unlinkFailed: "Could not unlink the Google account.",
    statusRefreshFailed: "The link was changed, but its status could not be refreshed. Check it again."
  },
  chatStack: {
  ...
  gbgScreen: {
    ...
    sectorNotifications: {
      muteTitle: "Mute notification sound",
      unmuteTitle: "Enable notification sound",
  ...
  drawer: {
    ...
    logoutTitle: "Sign out of the app?",
    logoutMessage: "The cache and all local app data will be cleared. Your account data on the server will not be deleted.",
    logoutCancel: "Cancel",
    logoutConfirm: "Sign out",
    logoutErrorTitle: "Could not sign out",
    logoutErrorMessage: "Could not clear the local data. Try again."
  },
  chatList: {
    title: "Messages",
...
const plOverrides = {
  ...
  userSettings: {
    ...
    close: "Zamknij",
    loginErrorTitle: "Nie udało się zalogować",
    loginErrorMessage: "Sprawdź połączenie i spróbuj ponownie."
  },
  googleAuth: {
    signIn: "Zaloguj się przez Google",
    notLinkedTitle: "Konto Google nie jest połączone",
    notLinkedMessage: "Zaloguj się kodem dostępu i połącz Google w Profilu.",
    configurationMissingTitle: "Logowanie Google nie jest skonfigurowane",
    configurationMissingMessage: "Google Sign-In nie został jeszcze skonfigurowany dla tej wersji.",
    errorTitle: "Błąd Google",
    errorMessage: "Nie udało się zalogować przez Google. Spróbuj ponownie.",
    title: "Konto Google",
    description: "Połącz Google, aby następnym razem logować się bez kodu dostępu.",
    loading: "Sprawdzanie połączenia…",
    sessionRequired: "Sesja logowania nie została potwierdzona. Zaloguj się ponownie do GuildChat, aby zarządzać logowaniem przez Google.",
    unlinked: "Google nie jest połączone",
    linked: "Google jest połączone",
    emailFallback: "Połączone konto Google",
    link: "Połącz Google",
    unlink: "Odłącz",
    retry: "Ponów",
    unlinkTitle: "Odłączyć Google?",
    unlinkMessage: "Po odłączeniu logowanie przez Google przestanie działać. Jeśli nie znasz kodu dostępu, połącz inne konto Google przed wylogowaniem z GuildChat.",
    cancel: "Anuluj",
    unlinkConfirm: "Odłącz",
    loadFailed: "Nie udało się sprawdzić połączenia Google.",
    linkFailed: "Nie udało się połączyć konta Google.",
    unlinkFailed: "Nie udało się odłączyć konta Google.",
    statusRefreshFailed: "Połączenie zostało zmienione, ale nie udało się odświeżyć jego stanu. Sprawdź ponownie."
  },
  chatStack: {
  ...
  gbgScreen: {
    ...
    sectorNotifications: {
      muteTitle: "Wyłącz dźwięk powiadomień",
      unmuteTitle: "Włącz dźwięk powiadomień",
  ...
  drawer: {
    ...
    logoutLabel: "Wyloguj",
    logoutTitle: "Wylogować się z aplikacji?",
    logoutMessage: "Pamięć podręczna i wszystkie lokalne dane aplikacji zostaną wyczyszczone. Dane konta na serwerze nie zostaną usunięte.",
    logoutCancel: "Anuluj",
    logoutConfirm: "Wyloguj",
    logoutErrorTitle: "Nie udało się wylogować",
    logoutErrorMessage: "Nie udało się wyczyścić lokalnych danych. Spróbuj ponownie."
  },
  chatList: {
    title: "Wiadomości",
...
const guaranteeTranslations = {
  uk: {
    ...
    plashka: {
      ownerAwaitingGuarantee: "Очікування гаранту. Вкладіть {{amount}} СО для гаранту на {{place}}-те місце",
      guaranteed: "Гарантоване",
      coverContributor: "Терміново вкласти {{amount}} СО для прикриття {{playerName}}",
      coverContributorNoName: "Терміново вкласти {{amount}} СО для прикриття вкладника на місці {{place}}",
      overflowOwner: "Перелив. Очікуємо вкладника з пропорційним внеском ({{amount}} СО)",
      overflowMember: "Перелив. Необхідно вкласти {{amount}} СО",
      readyToClose: "Готова до закриття",
      readyToCloseWithSkip: "Готова до закриття (можна перебити гравця на місці {{place}}, але це економічно недоцільно)",
      awaitingTopUp: "Очікуємо доплати від {{playerName}}",
      topUpTarget: "Вартість місця {{place}} складає {{placeCost}} СО. Треба докинути {{amount}} СО",
    },
  },
  ru: {
    ...
    plashka: {
      ownerAwaitingGuarantee: "Ожидание гаранта. Вложите {{amount}} СО для гаранта на {{place}}-е место",
      guaranteed: "Обеспечено",
      coverContributor: "Срочно вложить {{amount}} СО для прикрытия {{playerName}}",
      coverContributorNoName: "Срочно вложить {{amount}} СО для прикрытия вкладчика на месте {{place}}",
      overflowOwner: "Перелив. Ожидаем вкладчика с пропорциональным вкладом ({{amount}} СО)",
      overflowMember: "Перелив. Необходимо вложить {{amount}} СО",
      readyToClose: "Готова к закрытию",
      readyToCloseWithSkip: "Готова к закрытию (можно перебить игрока на месте {{place}}, но это экономически нецелесообразно)",
      awaitingTopUp: "Ожидаем доплаты от {{playerName}}",
      topUpTarget: "Стоимость места {{place}} составляет {{placeCost}} СО. Нужно добавить {{amount}} СО",
    },
  },
  be: {
    ...
    plashka: {
      ownerAwaitingGuarantee: "Чаканне гаранта. Укладзіце {{amount}} СО для гаранта на {{place}}-е месца",
      guaranteed: "Забяспечана",
      coverContributor: "Тэрмінова ўкласці {{amount}} СО для прыкрыцця {{playerName}}",
      coverContributorNoName: "Тэрмінова ўкласці {{amount}} СО для прыкрыцця ўкладчыка на месцы {{place}}",
      overflowOwner: "Перапаўненне. Чакаем укладчыка з прапарцыйным укладам ({{amount}} СО)",
      overflowMember: "Перапаўненне. Неабходна ўкласці {{amount}} СО",
      readyToClose: "Гатова да закрыцця",
      readyToCloseWithSkip: "Гатова да закрыцця (можна перабіць гульца на месцы {{place}}, але гэта эканамічна нямэтазгодна)",
      awaitingTopUp: "Чакаем даплаты ад {{playerName}}",
      topUpTarget: "Кошт месца {{place}} складае {{placeCost}} СО. Трэба дадаць {{amount}} СО",
    },
  },
  de: {
    ...
    plashka: {
      ownerAwaitingGuarantee: "Warten auf Garantie. Zahle {{amount}} FP für die Garantie auf Platz {{place}} ein",
      guaranteed: "Garantiert",
      coverContributor: "Dringend {{amount}} FP einzahlen, um {{playerName}} abzusichern",
      coverContributorNoName: "Dringend {{amount}} FP einzahlen, um den Beitragenden auf Platz {{place}} abzusichern",
      overflowOwner: "Überlauf. Warten auf einen Beitragenden mit anteiligem Beitrag ({{amount}} FP)",
      overflowMember: "Überlauf. {{amount}} FP müssen eingezahlt werden",
      readyToClose: "Bereit zum Abschluss",
      readyToCloseWithSkip: "Bereit zum Abschluss (Spieler auf Platz {{place}} könnte überboten werden, ist aber unwirtschaftlich)",
      awaitingTopUp: "Warten auf Aufstockung von {{playerName}}",
      topUpTarget: "Platz {{place}} kostet {{placeCost}} FP. Es fehlen {{amount}} FP",
    },
  },
  en: {
    ...
    plashka: {
      ownerAwaitingGuarantee: "Awaiting guarantee. Deposit {{amount}} FP to guarantee place {{place}}",
      guaranteed: "Guaranteed",
      coverContributor: "Urgently deposit {{amount}} FP to cover {{playerName}}",
      coverContributorNoName: "Urgently deposit {{amount}} FP to cover the contributor in place {{place}}",
      overflowOwner: "Overflow. Awaiting a contributor with a proportional deposit ({{amount}} FP)",
      overflowMember: "Overflow. Deposit {{amount}} FP",
      readyToClose: "Ready to close",
      readyToCloseWithSkip: "Ready to close (the player in place {{place}} can be overtaken, but it is not economical)",
      awaitingTopUp: "Awaiting a top-up from {{playerName}}",
      topUpTarget: "Place {{place}} costs {{placeCost}} FP. Top up {{amount}} FP",
    },
  },
  pl: {
    ...
    plashka: {
      ownerAwaitingGuarantee: "Oczekiwanie na gwarancję. Wpłać {{amount}} PR, aby zagwarantować miejsce {{place}}",
      guaranteed: "Zagwarantowane",
      coverContributor: "Pilnie wpłać {{amount}} PR, aby osłonić {{playerName}}",
      coverContributorNoName: "Pilnie wpłać {{amount}} PR, aby osłonić wkładcę na miejscu {{place}}",
      overflowOwner: "Przelew. Czekamy na wkładcę z proporcjonalnym wkładem ({{amount}} PR)",
      overflowMember: "Przelew. Należy wpłacić {{amount}} PR",
      readyToClose: "Gotowa do zamknięcia",
      readyToCloseWithSkip: "Gotowa do zamknięcia (można przebić gracza na miejscu {{place}}, ale jest to nieopłacalne)",
      awaitingTopUp: "Czekamy na dopłatę od {{playerName}}",
      topUpTarget: "Miejsce {{place}} kosztuje {{placeCost}} PR. Trzeba dopłacić {{amount}} PR",
    },
  },
};
