...
const deTranslation = {
  ...
  guildAdmin: {
    telegram: {
      ...
      errorTitle: "Fehler",
      permissionDenied: "Nur ein Administrator oder Tester dieser Gilde kann Telegram verbinden.",
...
const enOverrides = {
  ...
  guildAdmin: {
    telegram: {
      ...
      errorTitle: "Error",
      permissionDenied: "Only an administrator or tester of this guild can connect Telegram.",
...
const plOverrides = {
  ...
  guildAdmin: {
    telegram: {
      ...
      errorTitle: "Błąd",
      permissionDenied: "Tylko administrator lub tester tej gildii może połączyć Telegram.",
