...
const ukTranslation = {
  ...
  googleAuth: {
    ...
    verificationRequired: "Щоб продовжити, підтвердьте код доступу.",
    ...
    unlinkMessage: "Після цього ви зможете входити лише за кодом доступу.",
    cancel: "Скасувати",
    unlinkConfirm: "Відключити",
    verificationTitle: "Підтвердьте дію",
    verificationDescriptionLink: "Введіть чинний код доступу GuildChat, щоб підключити вхід через Google.",
    verificationDescriptionUnlink: "Введіть чинний код доступу GuildChat, щоб відключити вхід через Google.",
    accessCodePlaceholder: "Код доступу",
    accessCodeRequired: "Введіть код доступу.",
    verifyAndLink: "Підтвердити й підключити",
    verifyAndUnlink: "Підтвердити й відключити",
    loadFailed: "Не вдалося перевірити стан входу через Google.",
    authenticationFailed: "Код доступу не підтверджено.",
...
const ruTranslation = {
  ...
  googleAuth: {
    ...
    verificationRequired: "Подтвердите код доступа, чтобы проверить привязку.",
    ...
    unlinkMessage: "Вход через этот Google-аккаунт больше не будет работать. Вход по коду доступа останется доступным.",
    cancel: "Отмена",
    unlinkConfirm: "Отвязать",
    verificationTitle: "Подтвердите аккаунт",
    verificationDescriptionLink: "Введите действующий код доступа GuildChat перед привязкой Google.",
    verificationDescriptionUnlink: "Введите действующий код доступа GuildChat перед отвязкой Google.",
    accessCodePlaceholder: "Код доступа",
    accessCodeRequired: "Введите код доступа.",
    verifyAndLink: "Подтвердить и привязать",
    verifyAndUnlink: "Подтвердить и отвязать",
    loadFailed: "Не удалось проверить привязку Google.",
    authenticationFailed: "Код доступа не подтверждён.",
...
const beTranslation = {
  ...
  googleAuth: {
    ...
    verificationRequired: "Пацвердзіце код доступу, каб праверыць прывязку.",
    ...
    unlinkMessage: "Уваход праз гэты Google-акаўнт больш не будзе працаваць. Уваход па кодзе доступу застанецца даступным.",
    cancel: "Скасаваць",
    unlinkConfirm: "Адвязаць",
    verificationTitle: "Пацвердзіце акаўнт",
    verificationDescriptionLink: "Увядзіце дзейны код доступу GuildChat перад прывязкай Google.",
    verificationDescriptionUnlink: "Увядзіце дзейны код доступу GuildChat перад адвязваннем Google.",
    accessCodePlaceholder: "Код доступу",
    accessCodeRequired: "Увядзіце код доступу.",
    verifyAndLink: "Пацвердзіць і прывязаць",
    verifyAndUnlink: "Пацвердзіць і адвязаць",
    loadFailed: "Не ўдалося праверыць прывязку Google.",
    authenticationFailed: "Код доступу не пацверджаны.",
...
const deTranslation = {
  ...
  googleAuth: {
    ...
    verificationRequired: "Bestätigen Sie den Zugangscode, um die Verknüpfung zu prüfen.",
    ...
    unlinkMessage: "Die Anmeldung über dieses Google-Konto funktioniert danach nicht mehr. Der Zugangscode bleibt verfügbar.",
    cancel: "Abbrechen",
    unlinkConfirm: "Verknüpfung aufheben",
    verificationTitle: "Konto bestätigen",
    verificationDescriptionLink: "Geben Sie vor dem Verknüpfen den aktuellen GuildChat-Zugangscode ein.",
    verificationDescriptionUnlink: "Geben Sie vor dem Aufheben der Verknüpfung den aktuellen GuildChat-Zugangscode ein.",
    accessCodePlaceholder: "Zugangscode",
    accessCodeRequired: "Geben Sie den Zugangscode ein.",
    verifyAndLink: "Bestätigen und verknüpfen",
    verifyAndUnlink: "Bestätigen und aufheben",
    loadFailed: "Die Google-Verknüpfung konnte nicht geprüft werden.",
    authenticationFailed: "Der Zugangscode konnte nicht bestätigt werden.",
...
const enOverrides = {
  ...
  googleAuth: {
    ...
    verificationRequired: "Confirm your access code to check the link.",
    ...
    unlinkMessage: "Sign-in with this Google account will stop working. Access-code sign-in will remain available.",
    cancel: "Cancel",
    unlinkConfirm: "Unlink",
    verificationTitle: "Confirm your account",
    verificationDescriptionLink: "Enter your current GuildChat access code before linking Google.",
    verificationDescriptionUnlink: "Enter your current GuildChat access code before unlinking Google.",
    accessCodePlaceholder: "Access code",
    accessCodeRequired: "Enter the access code.",
    verifyAndLink: "Confirm and link",
    verifyAndUnlink: "Confirm and unlink",
    loadFailed: "Could not check the Google link.",
    authenticationFailed: "The access code could not be confirmed.",
...
const plOverrides = {
  ...
  googleAuth: {
    ...
    verificationRequired: "Potwierdź kod dostępu, aby sprawdzić połączenie.",
    ...
    unlinkMessage: "Logowanie tym kontem Google przestanie działać. Logowanie kodem dostępu pozostanie dostępne.",
    cancel: "Anuluj",
    unlinkConfirm: "Odłącz",
    verificationTitle: "Potwierdź konto",
    verificationDescriptionLink: "Wpisz aktualny kod dostępu GuildChat przed połączeniem Google.",
    verificationDescriptionUnlink: "Wpisz aktualny kod dostępu GuildChat przed odłączeniem Google.",
    accessCodePlaceholder: "Kod dostępu",
    accessCodeRequired: "Wpisz kod dostępu.",
    verifyAndLink: "Potwierdź i połącz",
    verifyAndUnlink: "Potwierdź i odłącz",
    loadFailed: "Nie udało się sprawdzić połączenia Google.",
    authenticationFailed: "Nie udało się potwierdzić kodu dostępu.",
